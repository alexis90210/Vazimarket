...
(function () {
  ...
  Riode.defaults = {
    ...
    minipopup: {
      ...
      purchasedTemplate:
        '<span class="purchased-time">IL Y A 12 MINUTES</span>',
    ...
    templateCartAddedAlert:
      ...
      '<a href="/cart" class="btn btn-success btn-md">Voir le panier</a>' +
      '<span>"{{name}}" a été ajouté à votre panier.</span>' +
  ...
  Riode.degree360 = function (selector) {
    ...
    Riode.$(selector).ThreeSixty({
      imagePath: "dashboard/images/demos/demo-single-product/degree/",
      filePrefix: "360-",
      ext: ".png",
      totalFrames: 32,
      endFrame: 32,
      ...
      self.$wrapper.on("click", ".btn-cart", function (e) {
        ...
        if (
          ...
          Riode.Minipopup.open({
            ...
            actionTemplate:
              '<div class="action-group d-flex mt-3"><a href="/cart" class="btn btn-sm btn-outline btn-primary btn-rounded mr-2">Voir le panier</a><a href="/checkout" class="btn btn-sm btn-primary btn-rounded"> Départ</a></div>',
          });
        }
      });
    };
      ...
      self.$wrapper.on("click", ".btn-compare", function (e) {
        ...
        if (
          ...
          Riode.Minipopup.open({
            ...
            count: $product.find(".quantity").val(),
            actionTemplate:
              '<div class="action-group d-flex mt-3"><a href="/compare" class="btn btn-sm btn-outline btn-primary btn-rounded mr-2">Comparer</a><a href="/checkout" class="btn btn-sm btn-primary btn-rounded">Vérifier</a></div>',
          });
        }
      });
    };
        ...
        callbacks: {
          open: function () {
            this.container.find(".product-gallery-degree").ThreeSixty({
              imagePath: "dashboard/images/product/shoes/",
    ...
    function initWishlistAction(e) {
      ...
      setTimeout(function () {
        $this
          ...
          .html(
            '<i class="d-icon-heart-full"></i> Parcourir la liste de souhaits'
          )
          .addClass("added")
          .attr("title", "Parcourir la liste de souhaits")
          .attr("href", "/wishlist");
      }, 500);
    }
                ...
                Riode.Minipopup.open({
                  ...
                  count:
                    $product.find(".quantity").length > 0
                      ...
                      : 1,
                  actionTemplate:
                    '<div class="action-group d-flex"><a href="/cart" class="btn btn-sm btn-outline btn-primary btn-rounded">Voir le panier</a><a href="/checkout" class="btn btn-sm btn-primary btn-rounded">Vérifier</a></div>',
                });
            } else {
              // if not product single, then open minipopup
              $product.hasClass("product-single") ||
    ...
    initProductsCompareAction: function () {
      Riode.$body
        ...
        .on("click", ".product .btn-product-icon.btn-compare", function (e) {
          ...
          $product.hasClass("product-single") ||
            Riode.Minipopup.open({
              message: "Ajouté à la liste de comparaison",
              productClass: " product-compare",
              name: $product.find(".product-name").text(),
              nameLink: $product.find(".product-name > a").attr("href"),
              imageSrc: $product.find(".product-media img").attr("src"),
              ...
              count:
                $product.find(".quantity").length > 0
                  ...
                  : 1,
              actionTemplate:
                '<div class="action-group d-flex"><a href="/compare" class="btn btn-sm btn-outline btn-primary btn-rounded">Comparer</a><a href="/checkout" class="btn btn-sm btn-primary btn-rounded">Vérifier</a></div>',
            });
        });
    },
    ...
    initProductsLoad: function () {
      $(".btn-load").on("click", function (e) {
        ...
        $.ajax({
          ...
          failure: function () {
            $this.text("Désolé, quelque chose s'est mal passé.");
          },
        });
      });
    },
    ...
    initWishlistButton: function (selector) {
      Riode.$body.on("click", selector, function (e) {
        ...
        setTimeout(function () {
          ...
          if ($this.hasClass("added")) {
            $this.attr("title", "Supprimer de la liste de souhaits");
          } else {
            $this.attr("title", "Ajouter à la liste de souhaits");
          }
        }, 500);
